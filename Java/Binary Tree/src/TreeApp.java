...
class TreeApp
   ...
   public static void main(String[] args) throws IOException
      ...
      while(true)
         ...
         System.out.print("random insert, insert, find, delete, clear tree, traverse, or quit: ");
         int choice = getChar();
         switch(choice)
            {
            case 's':
            ...
            case 't':
               ...
               ArrayList<Integer> preOrderList = new ArrayList<>(theTree.getPreOrderList());
               ArrayList<Integer> inOrderList = new ArrayList<>(theTree.getInOrderList());
               ArrayList<Integer> postOrderList = new ArrayList<>(theTree.getPostOrderList());
               theTree.root = null;
               theTree = new Tree();
               for (int val : postOrderList) {
                  theTree.insert(val, val + 0.9);
               }
               break;
            case 'q':
               System.exit(0);
...
// -------------------------------------------------------------
   public Node find(int key)      // find node with given key
      ...
      System.out.println("Comparisons during find: "+comps);
...
// -------------------------------------------------------------
   public void insert(int id, double dd)
      ...
      if(root==null)                // no node in root
         ...
         System.out.println("Comparisons during insert: "+comps);
      }  // end insert()
// -------------------------------------------------------------
   public boolean delete(int key) // delete node with given key
      ...
      System.out.println("Comparisons in delete: " + comps);
      return true;                                // success
      }  // end delete()
// -------------------------------------------------------------
...
// -------------------------------------------------------------
   private void preOrder(Node localRoot)
      ...
      if(localRoot != null)
         ...
         preOrderList.add(localRoot.iData);
...
// -------------------------------------------------------------
   private void inOrder(Node localRoot)
      ...
      if(localRoot != null)
         ...
         System.out.print(localRoot.iData + " ");
         inOrderList.add(localRoot.iData);
...
// -------------------------------------------------------------
   private void postOrder(Node localRoot)
      ...
      if(localRoot != null)
         ...
         System.out.print(localRoot.iData + " ");
         postOrderList.add(localRoot.iData);
         }
      }
// -------------------------------------------------------------
   ...
   public int minItem() {
      Node current = root;
      if(current == null) return -1; // tree is empty
